  ...
  return {
    ...
    input_schema: {
      ...
      properties: {
        ...
        preferred_time: { type: "string", description: "Preferred time of day for the office (morning / afternoon / evening, or a day+time window they already named, e.g. Wednesday afternoon or after 3). Not a confirmed slot. Ask once if they have not already said it; pass what they said." },
      },
    },
  };
}
